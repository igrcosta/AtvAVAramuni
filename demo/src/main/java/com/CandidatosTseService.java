...
import com.atvAV.demo.model.Candidato;
...
public class CandidatosTseService {
    ...
    public void carregarCsv() {
        ...
        ClassPathResource recursoCsv = new ClassPathResource(CAMINHO_CSV);
        if (!recursoCsv.exists()) {
        ...
        try (Reader reader = new InputStreamReader(
                recursoCsv.getInputStream(), StandardCharsets.ISO_8859_1);
